...
export const VpnDashboard: React.FC<Props> = ({ status, onToggle, server, onSelectServer, errorMessage, onSimulateInterruption, onAILoadBalance, isAILoading }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Error Message Alert */}
      {isFailed && (
        <div className="bg-rose-500/10 border border-rose-500/20 rounded-3xl p-5 flex flex-col md:flex-row items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Main Connect Panel */}
        <div className="bg-[#050505] border border-white/5 rounded-3xl p-8 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="mb-10 text-center">
              <h2 className={`text-3xl font-light tracking-tight mb-2 ${isFailed ? 'text-rose-400' : ''}`}>
            ...
            <div className="mt-12 flex items-center gap-3 bg-[#0A0A0A] px-5 py-2.5 rounded-full border border-white/5">
              <div className={`w-2 h-2 rounded-full ${isConnected ? 'bg-emerald-500 shadow-[0_0_10px_#10b981]' : isConnecting ? 'bg-yellow-500' : isFailed ? 'bg-rose-500 shadow-[0_0_10px_#f43f5e]' : 'bg-gray-600'}`} />
              <span className={`text-[10px] font-mono uppercase tracking-widest ${isFailed ? 'text-rose-400' : 'text-gray-400'}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#050505] border border-white/5 rounded-3xl p-6 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-light tracking-tight text-white mb-2">Smart Routing</h3>
              <p className="text-sm text-gray-500 font-light mb-5">Automatically connect to the least congested server in your preferred region.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <select 
                    ...
                    className="w-full bg-[#0A0A0A] border border-white/10 rounded-xl py-3 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-indigo-500/50 appearance-none cursor-pointer"
                ...
                <button 
                  ...
                  disabled={isConnecting || isConnected}
                  className="bg-white text-black px-6 py-3 rounded-xl text-sm font-medium hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:hover:bg-white whitespace-nowrap"
                >
                  Auto-Connect
                </button>
              </div>
          ...
          <div className="bg-[#050505] border border-white/5 rounded-3xl p-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-medium tracking-tight">{server.name}</h3>
                <p className="text-sm text-gray-500 font-light">{server.country} &bull; {server.region}</p>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 grid grid-cols-2 gap-4">
              <div className="flex items-center gap-4">
                <div className="p-2.5 bg-[#0A0A0A] rounded-xl border border-white/5"><ShieldCheck className="w-4 h-4 text-gray-400" /></div>
                <div>
              ...
              <div className="flex items-center gap-4">
                <div className="p-2.5 bg-[#0A0A0A] rounded-xl border border-white/5"><MapPin className="w-4 h-4 text-gray-400" /></div>
                <div>
